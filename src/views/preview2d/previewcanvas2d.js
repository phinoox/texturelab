...
export var DrawMode;
(function (DrawMode) {
    DrawMode[DrawMode["Single"] = 0] = "Single";
    DrawMode[DrawMode["Nine"] = 1] = "Nine";
})(DrawMode || (DrawMode = {}));
class Rect {
    constructor() {
        this.visible = true;
...
export class DragZoom {
    ...
    centerImage() {
        this.offset = new Vector2(this.canvas.width * 0.5, this.canvas.height * 0.5);
        this.zoomFactor = 0.4;
    }
    setImage(image) {
        this.image = image;
    ...
    draw() {
        ...
        ctx.setTransform(this.zoomFactor, 0, 0, this.zoomFactor, this.offset.x, this.offset.y);
        // ctx.translate(this.offset.x, this.offset.y);
        // ctx.scale(this.zoomFactor, this.zoomFactor);
    ...
    drawImage(offsetX, offsetY) {
        this.context.drawImage(this.image, -IMAGE_RENDER_SIZE * 0.5 + offsetX * IMAGE_RENDER_SIZE, -IMAGE_RENDER_SIZE * 0.5 + offsetY * IMAGE_RENDER_SIZE, IMAGE_RENDER_SIZE, IMAGE_RENDER_SIZE);
    }
...
//# sourceMappingURL=previewcanvas2d.js.map